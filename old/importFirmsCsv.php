...
for($x = 0;$x < $lines;$x++){
    ...
    if($count>0){
    echo "$name - p�eskakuji <br>";
        continue;
    }
    
    /*zde jsou uvedeny jednotlivé položky které se vyskytují v tabulce a je zde uvedeno pod jakým ID pracují*/ 
    ...
    $note = null;
    /*funkce na vkládání nových dat do firem.*/ 
